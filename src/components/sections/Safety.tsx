...
const measures = [
  ...
  },
  {
    ...
    desc: 'Более 10 камер. Все общественные зоны под наблюдением.',
  },
  {
    icon: Heart,
  ...
  },
  {
    ...
    desc: 'Каждый сотрудник проверен по реестру МВД. Образование — обязательное требование.',
  },
  {
    icon: Lock,
    title: 'Ночной режим',
          ...
          <div className="grid md:grid-cols-3 gap-6 items-center">
            <div className="md:col-span-2">
              ...
              <p className="text-white/75 text-sm leading-relaxed mb-4">
                Лагерь работает по лицензии, проходит ежегодные плановые проверки Роспотребнадзора, МЧС и МВД. Результаты проверок — в открытом доступе в разделе «Документы».
              </p>
              <div className="flex flex-wrap gap-3">
                {['Роспотребнадзор', 'МЧС', 'МВД'].map((org) => (
