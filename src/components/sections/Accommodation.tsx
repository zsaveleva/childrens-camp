...
const housing = [
  'Современные корпуса 2018–2020 годов постройки',
  '4–6 человек в комнате, раздельные мальчики/девочки',
  'Горячая вода и индивидуальные душевые кабины',
  'Wi-Fi на всей территории',
  'Ежедневная уборка и смена белья раз в неделю',
  'Просторные холлы для отдыха с мягкой мебелью',
  'Отдельные секции для разных возрастных групп',
]

const food = [
  '5-разовое питание: завтрак, 2-й завтрак, обед, полдник, ужин',
  ...
  'Еженедельное меню публикуется в группе ВКонтакте',
]
